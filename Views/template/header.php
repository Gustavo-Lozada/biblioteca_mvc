...
<head>
    ...
    <title>Sistema de biblioteca UCACUE</title>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer bg-primary">
                    <div class="small">VISITANOS: </div>
                    <a href="https://www.facebook.com/universidadcatolicacuenca" class="text-white"><i class="fab fa-facebook-square"></i> Facebook</a>
                    <a href="https://www.instagram.com/ucatolicacuenca/?hl=es" class="text-danger"><i class="fab fa-instagram-square"></i> Instagram</a>
                </div>
            </nav>
        </div>